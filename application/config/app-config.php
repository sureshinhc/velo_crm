...
*
*/
define('APP_BASE_URL', 'https://www.velo.firefly-crm.co.il/');
...
*/
define('APP_ENC_KEY', '31705786e017af5e24601efb87b1cde4');
 ...
 */
define('APP_DB_USERNAME', 'qsymewunxb');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Y4dMy7pBAK');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'qsymewunxb');
